...
public class ScheduleController {
    ...
    @GetMapping("/selectByIdAndDate")
    public Result selectByIdAndDate(@RequestParam Integer id, @RequestParam Date date) {
        Schedule schedule = scheduleService.selectByIdAndDate(id, date);
        return Result.success(schedule);
    }
