<template>
  <div>
    <div class="search">
      <el-input placeholder="请输入计划日期查询" style="width: 200px" v-model="date"></el-input>
    ...
    <div class="table">
      <el-table :data="tableData" stripe  @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="date" label="计划日期" show-overflow-tooltip></el-table-column>
    ...
    <el-dialog title="信息" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false" destroy-on-close>
      <el-form label-width="100px" style="padding-right: 50px" :model="form" :rules="rules" ref="formRef">
        <el-form-item prop="categoryId" label="计划表类别">
...
export default {
  ...
  methods: {
    loadGategory(){
      this.$request.get('scheduleCategory/selectAll').then(res=>{
        if(res.code == '200'){
