<template>
  <div>
    <div class="search">
      <el-input placeholder="请输入订单号查询" style="width: 200px" v-model="id"></el-input>
    ...
    <el-dialog title="订单" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false" destroy-on-close>
      <el-form label-width="100px" style="padding-right: 50px" :model="form" :rules="rules" ref="formRef">
        ...
        <el-form-item prop="details" label="详情信息">
          <el-input type="textarea" :rows="5" v-model="form.details" autocomplete="off"></el-input>
        </el-form-item>
      </el-form>
